...
3. Do NOT revise or refine the article ideas generated by the Content Writer; instead, copy them exactly as is
...
[Copy the article ideas from the Content Writer exactly as is, without any changes]
