...
3. Do NOT revise or refine the article ideas generated by the Content Writer; instead, copy them exactly as is (the variable {{article_ideas}} will be replaced with the output from the Content Writer)
